    ...
    return <header className={s.header}>
        ...
        <div className={s.loginBlock}>
            {props.authState.isAuth
                ? <div className={s.loginNameAndLogOut}>{props.authState.login}  <Button variant='contained' size='small' style={{margin: '13px'}} onClick={() => dispatch(logoutTC())}>Log out</Button></div>
                : <NavLink
